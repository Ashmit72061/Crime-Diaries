...
export default {
  ...
  mapRow: (r) => {
    ...
    return {
      ...
      complainant_details: formatPersonNoAge(d.complainant_name, d.complainant_father_husband_name || d.father_husband_name, d.complainant_address),
      time_of_occurrence:  d.occurrence_time || d.gd_time || '',
      place_of_occurrence: d.occurrence_place || '',
      gist:                d.brief_facts || '',
      arrested_details:    formatPerson(d.arrested_person || d.accused_name, d.age, d.arrested_father_husband_name || d.accused_father_name, d.arrested_address || d.accused_address) || 'None',
    };
  },
};
