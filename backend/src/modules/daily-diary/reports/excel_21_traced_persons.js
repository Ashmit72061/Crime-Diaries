...
export default {
  ...
  mapRow: (r, idx) => {
    ...
    return {
      ...
      traced_person_details: formatPersonNoAge(d.missing_name, d.father_husband_name || d.complainant_father_husband_name, d.missing_address || d.mp_address || d.address),
