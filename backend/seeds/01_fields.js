...
const fields = [
 ...
 // { id: 'C_incident_pl',field_key: 'place_of_incident',   field_type: 'TEXT',     applicable_record_types: JSON.stringify(['PCR_CALL']), label_en: 'Place of Incident',          label_hi: 'घटना का स्थान',                 visible_to_levels: L, editable_by_levels: E, section: 'general_info',            sort_order: 1.4 },
  ...
  { id: 'PH_1', field_key: 'phone_make',                  field_type: 'TEXT',     applicable_record_types: JSON.stringify([]),           label_en: 'Phone Make / Brand',                      label_hi: 'फोन का ब्रांड',                         visible_to_levels: L, editable_by_levels: E, section: 'Property Details',        sort_order: 310, is_active: true, scope_level: 'global' },
  { id: 'PH_2', field_key: 'phone_model',                 field_type: 'TEXT',     applicable_record_types: JSON.stringify([]),           label_en: 'Phone Model',                             label_hi: 'फोन का मॉडल',                           visible_to_levels: L, editable_by_levels: E, section: 'Property Details',        sort_order: 311, is_active: true, scope_level: 'global' },
  { id: 'PH_3', field_key: 'phone_imei',                  field_type: 'TEXT',     applicable_record_types: JSON.stringify([]),           label_en: 'IMEI Number',                             label_hi: 'आईएमईआई नंबर',                          visible_to_levels: L, editable_by_levels: E, section: 'Property Details',        sort_order: 312, is_active: true, scope_level: 'global' },
  { id: 'PH_4', field_key: 'phone_color',                 field_type: 'TEXT',     applicable_record_types: JSON.stringify([]),           label_en: 'Phone Color',                             label_hi: 'फोन का रंग',                            visible_to_levels: L, editable_by_levels: E, section: 'Property Details',        sort_order: 313, is_active: true, scope_level: 'global' },
  { id: 'PH_5', field_key: 'phone_status',                field_type: 'SELECT',   applicable_record_types: JSON.stringify([]),           label_en: 'Phone Recovery Status',                   label_hi: 'फोन बरामदगी स्थिति',                    visible_to_levels: L, editable_by_levels: E, section: 'Property Details',        sort_order: 314, is_active: true, scope_level: 'global', options: JSON.stringify([{ value: 'NOT_RECOVERED', label_en: 'Not Recovered', label_hi: 'बरामद नहीं' }, { value: 'RECOVERED', label_en: 'Recovered', label_hi: 'बरामद' }, { value: 'PARTIAL', label_en: 'Partially Recovered', label_hi: 'आंशिक रूप से बरामद' }]) },
